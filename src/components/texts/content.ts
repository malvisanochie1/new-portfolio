export const services = [
  {
    ...
    icon: "🖥️", // Placeholder; replace with react-icons or SVG
  },
  {
  ...
  },
  {
    ...
    description:
      "I efficiently implement and customize components from modern UI libraries like Flowbite, shadcn/ui, and Aeternity UI to match your brand.",
