...
const services = [
  ...
  },
  {
    ...
    description: "I identify and fix layout, styling, or rendering issues to improve your site’s responsiveness, usability, and performance.",
    gradient: "from-teal-600 to-cyan-600",
    icon: () => <span className="text-2xl">🔧</span>,
  },
  {
    title: "Mobile-First Redesign",
    description: "I upgrade or refactor old websites into sleek, mobile-friendly interfaces that meet modern standards and improve user experience.",
    gradient: "from-cyan-600 to-blue-600",
    icon: () => <span className="text-2xl">📱</span>,
  },
  {
    title: "Frontend Refactoring & Cleanup",
    description: "I optimize existing codebases by refactoring cluttered CSS/JS, organizing components, and improving maintainability.",
    gradient: "from-blue-600 to-indigo-600",
    icon: () => <span className="text-2xl">🔄</span>,
  },
  {
    title: "Performance Optimization",
    description: "I implement best practices like lazy loading, clean rendering, and layout shifts prevention for faster and smoother UX.",
    gradient: "from-indigo-600 to-purple-600",
    icon: () => <span className="text-2xl">🔍</span>,
  },
  {
    title: "Accessible & Headless UI Development",
    description: "I build components that are screen-reader-friendly and accessible via keyboard navigation, following WCAG and ARIA guidelines.",
    gradient: "from-purple-600 to-pink-600",
    icon: () => <span className="text-2xl">🔐</span>,
  },
  {
    title: "Version Control & Collaboration",
    description: "I use Git and GitHub for collaborative workflow, code versioning, and secure deployment processes.",
    gradient: "from-pink-600 to-red-600",
    icon: () => <span className="text-2xl">🛠️</span>,
  },
];
...
export default function MyServices() {
  return (
    <section className="bg-[#0a0a16] py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-400 text-sm max-w-2xl">
            I am a skilled web developer with expertise in creating innovative and user-friendly websites. My passion
            for coding and my attention to detail allow me to create custom solutions.
          </p>
        </div>
