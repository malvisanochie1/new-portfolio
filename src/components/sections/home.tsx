...
export default function Homesec() {
  ...
  return (
    <motion.div
      className="min-h-screen bg-[#0a0a16] text-white"
    ...
    >
      <div className="container- px-4 sm:px-6 lg:px-8 py-12 md:py-20 max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          {/* Left Content */}
          <motion.div className="lg:w-1/2 space-y-6" variants={leftContentVariants}>
            <motion.p className="text-sm md:text-base tracking-wider" variants={textVariants}>
            ...
            <motion.h1 className="text-4xl md:text-5xl font-bold leading-tight" variants={textVariants}>
              Maximize Your Business{" "}
              <motion.span
                className="text-[#ff3366] block md:inline"
                animate={{
                  textShadow: ["0 0 0px #ff3366", "0 0 10px #ff3366", "0 0 0px #ff3366"],
                }}
                transition={{
                  duration: 2,
                  repeat: Number.POSITIVE_INFINITY,
            ...
            <motion.h2 className="text-3xl md:text-4xl font-bold" variants={textVariants}>
              Development{" "}
            ...
            <motion.p className="text-sm md:text-base text-gray-400 max-w-lg" variants={textVariants}>
              Take your business to the next level with custom web development solutions.
            </motion.p>

            <motion.div className="flex flex-wrap gap-4 pt-4" variants={textVariants}>
          ...
          <motion.div className="lg:w-1/2 relative" variants={rightContentVariants}>
            <div className="relative">
              ...
              >
                <Image src="/home/profile.jpg" alt="Web Developer" width={400} height={400} className="object-cover" />
              </motion.div>
